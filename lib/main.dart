...
//    return MyCustomRoute(
  ...
  Route<dynamic> _getRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      case SplashScreenActivity.routeName:
        screen = SplashScreenActivity(title: "Demo",);
        break;
      case LoginScreenActivity.routeName:
        screen = LoginScreenActivity();
        break;
    ...
    // screen = EditScreenViewActivity();
    // break;

    // case MobileOtpScreen.routeName:
    //   screen = MobileOtpScreen();
    //   break;
    // case OTPVerifyScreen.routeName:
    //   screen = OTPVerifyScreen(arguments: settings.arguments);
    //   break;
      default:
        screen = Text("Cannot find destination");
    }
